...
class VLM:
    ...
    async def generate_parallel(self, requests: List[VLMRequest]) -> List[Tuple[int, Optional[VLMResponse], Optional[Exception]]]:
        ...
        """
        async def _process_request(index: int, request: VLMRequest):
            try:
