...
from vlm_autoeval_robot_benchmark.utils.rate_limit import rate_limiter, RateLimitConfig, ProviderRateLimits
...
def load_rate_limits() -> RateLimitConfig:
    ...
    if config_path:
        ...
        providers = {
            provider: ProviderRateLimits(models=models)
            for provider, models in yaml_data.items()
        }
